CLASS zcl_insert_data_2295 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_INSERT_DATA_2295 IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.

    DATA: lt_travel   TYPE TABLE OF ztb_travel_2295,
          lt_booking  TYPE TABLE OF ztb_booking_2295,
          lt_book_sup TYPE TABLE OF ztb_bksuppl_2295.
    ...
    DELETE FROM:  ztb_travel_2295,
                                ztb_booking_2295,
                                ztb_bksuppl_2295.

    INSERT : ztb_travel_2295      FROM TABLE @lt_travel,
                   ztb_booking_2295  FROM TABLE @lt_booking,
                   ztb_bksuppl_2295  FROM TABLE @lt_book_sup.
